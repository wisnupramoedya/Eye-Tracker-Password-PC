...
from PyQt6.QtWidgets import QLabel, QPushButton, QSlider, QMainWindow
...
class CameraWindow(QMainWindow):
    FILE_PATH: Path = Settings.ASSETS / "MainGUI.ui"
    ...
    def __init__(self, capture: Capture, video_source: FrameSource):
